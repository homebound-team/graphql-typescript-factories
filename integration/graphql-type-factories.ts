import { Author, AuthorSummary, Book, BookReview, CalendarInterval, Child, PopularityDetail, SaveAuthorResult, SearchResults, WorkingDetail, Named, Popularity, Working } from './graphql-types-only';
import { newDate } from './testData';

const factories: Record<string, Function> = {}
    export interface AuthorOptions {
      __typename?: 'Author';
      import { Author } from './graphql-types-only';
...
name?: Author["name"];
import { Popularity } from './graphql-types-only';
...
import { Working } from './graphql-types-only';
...
workingDetail?: WorkingDetailOptions | Working;
    ...
    export function newAuthor(options: AuthorOptions = {}, cache: Record<string, any> = {}): Author {
      ...
      o.__typename = 'Author';
      o.birthday = options.birthday ?? null;o.bookPopularities = (options.bookPopularities ?? []).map(i => enumOrDetailOfPopularity(i));o.books = (options.books ?? []).map(i => maybeNewBook(i, cache, options.hasOwnProperty("books")));o.id = options.id ?? nextFactoryId("Author");o.name = options.name ?? "name";o.popularity = enumOrDetailOfPopularity(options.popularity);o.summary = maybeNewAuthorSummary(options.summary, cache, options.hasOwnProperty("summary"));o.working = options.working ?? null;o.workingDetail = enumOrDetailOfWorking(options.workingDetail);
      return o;
    }
    ...
    export interface AuthorSummaryOptions {
      ...
      import { AuthorSummary } from './graphql-types-only';
...
numberOfBooks?: AuthorSummary["numberOfBooks"];
    ...
    export function newAuthorSummary(options: AuthorSummaryOptions = {}, cache: Record<string, any> = {}): AuthorSummary {
      ...
      o.amountOfSales = options.amountOfSales ?? null;o.author = maybeNewAuthor(options.author, cache, options.hasOwnProperty("author"));o.id = options.id ?? nextFactoryId("AuthorSummary");o.numberOfBooks = options.numberOfBooks ?? 0;
      return o;
    }
    ...
    function maybeNewAuthorSummary(value: AuthorSummaryOptions | undefined, cache: Record<string, any>, isSet: boolean = false): AuthorSummary {
      if (value === undefined) {
    ...
    function maybeNewOrNullAuthorSummary(value: AuthorSummaryOptions | undefined | null, cache: Record<string, any>): AuthorSummary | null {
      if (!value) {
        return null;
      } else if (value.__typename) {
        return cache.all?.has(value) ? value : factories[value.__typename](value, cache);
...
import { Book } from './graphql-types-only';
...
reviews?: Array<BookReviewOptions | null> | null;
    ...
    export function newBook(options: BookOptions = {}, cache: Record<string, any> = {}): Book {
      ...
      (cache.all ??= new Set()).add(o);
      o.__typename = 'Book';
      o.coauthor = maybeNewOrNullAuthor(options.coauthor, cache);o.name = options.name ?? "name";o.popularity = enumOrDetailOrNullOfPopularity(options.popularity);o.reviews = (options.reviews ?? []).map(i => maybeNewOrNullBookReview(i, cache));
      return o;
    }
    ...
    export interface BookReviewOptions {
      ...
      import { BookReview } from './graphql-types-only';
...
rating?: BookReview["rating"];
    ...
    function maybeNewBookReview(value: BookReviewOptions | undefined, cache: Record<string, any>, isSet: boolean = false): BookReview {
      if (value === undefined) {
    ...
    function maybeNewOrNullBookReview(value: BookReviewOptions | undefined | null, cache: Record<string, any>): BookReview | null {
      if (!value) {
        return null;
      } else if (value.__typename) {
        return cache.all?.has(value) ? value : factories[value.__typename](value, cache);
    ...
    export interface CalendarIntervalOptions {
      ...
      import { CalendarInterval } from './graphql-types-only';
...
start?: CalendarInterval["start"];
    ...
    export function newCalendarInterval(options: CalendarIntervalOptions = {}, cache: Record<string, any> = {}): CalendarInterval {
      const o = (options.__typename ? options : cache["CalendarInterval"] = {}) as CalendarInterval;
      (cache.all ??= new Set()).add(o);
      o.__typename = 'CalendarInterval';
      o.end = options.end ?? newDate();o.start = options.start ?? newDate();
      return o;
    }
    ...
    function maybeNewCalendarInterval(value: CalendarIntervalOptions | undefined, cache: Record<string, any>, isSet: boolean = false): CalendarInterval {
      if (value === undefined) {
    ...
    function maybeNewOrNullCalendarInterval(value: CalendarIntervalOptions | undefined | null, cache: Record<string, any>): CalendarInterval | null {
      if (!value) {
        return null;
      } else if (value.__typename) {
        return cache.all?.has(value) ? value : factories[value.__typename](value, cache);
    ...
    export interface ChildOptions {
      __typename?: 'Child';
      import { Child } from './graphql-types-only';
...
parent?: Child["parent"];
    ...
    export interface PopularityDetailOptions {
      ...
      import { PopularityDetail } from './graphql-types-only';
...
name?: PopularityDetail["name"];
    ...
    export function newPopularityDetail(options: PopularityDetailOptions = {}, cache: Record<string, any> = {}): PopularityDetail {
      const o = (options.__typename ? options : cache["PopularityDetail"] = {}) as PopularityDetail;
      (cache.all ??= new Set()).add(o);
      o.__typename = 'PopularityDetail';
      o.code = options.code ?? Popularity.High;o.name = options.name ?? "High";
      return o;
    }
...
author?: AuthorOptions;
    ...
    export function newSaveAuthorResult(options: SaveAuthorResultOptions = {}, cache: Record<string, any> = {}): SaveAuthorResult {
    ...
    function maybeNewSaveAuthorResult(value: SaveAuthorResultOptions | undefined, cache: Record<string, any>, isSet: boolean = false): SaveAuthorResult {
      if (value === undefined) {
    ...
    function maybeNewOrNullSaveAuthorResult(value: SaveAuthorResultOptions | undefined | null, cache: Record<string, any>): SaveAuthorResult | null {
      if (!value) {
        return null;
      } else if (value.__typename) {
        return cache.all?.has(value) ? value : factories[value.__typename](value, cache);
    ...
    export interface SearchResultsOptions {
      ...
      import { SearchResults } from './graphql-types-only';
...
result3?: AuthorOptions | null;
    ...
    export function newSearchResults(options: SearchResultsOptions = {}, cache: Record<string, any> = {}): SearchResults {
      ...
      o.result1 = options.result1 ?? null;o.result2 = options.result2 ?? null;o.result3 = maybeNewOrNullAuthor(options.result3, cache);
      return o;
    }
    ...
    function maybeNewSearchResults(value: SearchResultsOptions | undefined, cache: Record<string, any>, isSet: boolean = false): SearchResults {
      if (value === undefined) {
    ...
    function maybeNewOrNullSearchResults(value: SearchResultsOptions | undefined | null, cache: Record<string, any>): SearchResults | null {
      if (!value) {
        return null;
      } else if (value.__typename) {
        return cache.all?.has(value) ? value : factories[value.__typename](value, cache);
    ...
    export interface WorkingDetailOptions {
      ...
      import { WorkingDetail } from './graphql-types-only';
...
name?: WorkingDetail["name"];
    ...
    export function newWorkingDetail(options: WorkingDetailOptions = {}, cache: Record<string, any> = {}): WorkingDetail {
      ...
      o.code = options.code ?? Working.No;o.extraField = options.extraField ?? 0;o.name = options.name ?? "No";
      return o;
    }
    ...
    factories["WorkingDetail"] = newWorkingDetail;
      ...
      function enumOrDetailOrNullOfPopularity(enumOrDetail: PopularityDetailOptions | Popularity | undefined | null): PopularityDetail | null {
      ...
      function enumOrDetailOrNullOfWorking(enumOrDetail: WorkingDetailOptions | Working | undefined | null): WorkingDetail | null {
        if (enumOrDetail === null) {
          return null;
        }
